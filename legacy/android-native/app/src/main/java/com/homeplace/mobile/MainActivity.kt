...
import com.homeplace.mobile.protocol.protocolMax
import com.homeplace.mobile.protocol.protocolMin
import com.homeplace.mobile.protocol.serverId
import com.homeplace.mobile.protocol.serverName
...
private fun ServerPreview(state: com.homeplace.mobile.ui.ConnectionState, onEdit: () -> Unit) {
    ...
    Text(
        stringResource(if (info.features.pairing) R.string.server_ready else R.string.server_verified),
